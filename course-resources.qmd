...
## Required Packet, Recommended Texts, and Website

*Course Packet (Lab Manual)* There is a required course packet which is the lab manual for the class. This will be available for purchase at the bookstore in Coffman Memorial Union the week of 1/20. The course packet is provided on the course Canvas site as a pdf file so that you can view it digitally. **HOWEVER, please note that a hard copy of the lab manual is required for lab.** Lab does not start until the second week of class. You are also free to print the lab packet out on your own if you choose (pdf is provided on the Canvas site, but it is likely cheaper, faster and easier just to purchase a copy from the bookstore.
