...
4.  You will then be prompted for a password. IF you have previously created a Poll Everywhere account for a different class, then you will have an existing password. Otherwise, your password will be: 2125-\[your 7 digit student ID number\]. So, if my ID number is 1234567, then my password is **2125-1234567**. **Make sure to use your 7 digit student ID (all numbers) - this should be the same 7 digit number that is on your ID card NOT your x500 (the first part of your email)**.
